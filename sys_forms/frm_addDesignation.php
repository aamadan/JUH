<?php session_start();?>
            <div class="card card-primary card-outline">
              ...
              <form role="form" action="actions/insert.php" method="POST" enctype="multipart/form-data" id="sys_form_res">
                <input type="hidden" name="sp" value="sp_designation">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="designation">Designation Name</label>
                        <input type="text" name="designation"class="form-control" id="designation" placeholder="Enter Designation name" required>
                      </div>
                    </div>                     
                  </div>
