...
?>
            <div class="card card-primary card-outline">
              ...
              <form role="form" action="actions/insert.php" method="POST" enctype="multipart/form-data" id="sys_form_res">
                <input type="hidden" name="sp" value="sp_service_type">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Select Service</label>
                        <select class="form-control select2" style="width: 100%;" name="lab_name" id="service_name" required>
                            <option selected="selected" value="-1" disabled="">Select Service</option>
                            <?php
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="service_type" class="form-control" id="service_type" placeholder="Enter Service type" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
