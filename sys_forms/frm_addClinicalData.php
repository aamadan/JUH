...
?>
            <div class="card card-primary card-outline">
              ...
              <form role="form" action="actions/insert.php" method="POST" enctype="multipart/form-data" id="sys_form_res">
                <input type="hidden" name="sp" value="sp_insert_clinicalData">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Select Image</label>
                        <select class="form-control select2" style="width: 100%;" name="image_name" id="image_name" required>
                            <option selected="selected" value="">Select Image</option>
                            <?php
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="lab_test_name">Clinical Data</label>
                        <input type="text" name="clinicalData_name" class="form-control" id="clinicalData_name" placeholder="Enter Clinical Data" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
