<?php session_start();?>
            <div class="card card-primary card-outline">
              ...
              <form role="form" action="actions/insert.php" method="POST" enctype="multipart/form-data" id="sys_form_res">
                <input type="hidden" name="sp" value="sp_department">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" name="dept_name"class="form-control" id="dept_name" placeholder="Enter Department name" required>
                      </div>
                    </div>                     
                  </div>
