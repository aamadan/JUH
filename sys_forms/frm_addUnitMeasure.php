<?php session_start();?>
            <div class="card card-primary card-outline">
              ...
              <form role="form" action="actions/insert.php" method="POST" enctype="multipart/form-data" id="sys_form_res">
                <input type="hidden" name="sp" value="sp_unit_measure">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="unit_measure">Unit Measure</label>
                        <input type="text" name="unit_measure"class="form-control" id="unit_measure" placeholder="Enter Unit Measure" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="unit_desc">Description</label>
                        <textarea class="form-control" name="unit_desc" id="unit_desc" required rows="3"></textarea>
                      </div>
                    </div>                     
                  </div>
