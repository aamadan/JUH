          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <a href="sys_forms/frm_addDoctor.php" class="update_link"><button class="btn btn-primary btn-sm" style="float:right;margin-left: 15px;"> <span class="fas fa-plus mr-3"></span> Add New</button> </a>
                <table id="rpt" class="table table-hover text-nowrap">
                  ...
                  ?>
                    <tr>
                      ...
                      <td style="color: black;"><?php echo $row["Full Name"]?></td>
                      ...
                      <td style="color: black;"><?php echo $row["Specialist"]?></td>
                      <td style="color: black;"><?php echo $row["Office Tell"]?></td>
                      <td style="color: black;"><?php echo $row["Gender"]?></td>
                      <td style="color: black;"><?php echo $row["Blood Group"]?></td>
                      <td style="color: black;"><?php echo $row["Biography"]?></td>
