          <div class="card">
            <!-- /.card-header -->
            <div class="card-body">
               <a href="sys_forms/frm_addImage.php" class="update_link"><button class="btn btn-primary btn-sm" style="float:right;margin-left: 15px;"> <span class="fas fa-plus mr-3"></span> Add New</button> </a>
              <table id="rpt" class="table table-hover">
                ...
                ?>
                   <tr>
                    ...
                    <td style="color: black;"><?php echo $row["Image Name"]?></td>
