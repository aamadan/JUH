          <div class="card">
            ...
            <div class="card-body">
               ...
               <div class="table-responsive">
                <a href="sys_forms/frm_addUnitMeasure.php" class="update_link"><button class="btn btn-primary btn-sm" style="float:right;margin-left: 15px;"> <span class="fas fa-plus mr-3"></span> Add New</button> </a>
              <table id="rpt" class="table table-hover table-bordered table-striped">
                ...
                ?>
                   <tr>
                    ...
                    <td style="color: black;"><?php echo $row["Unit Measure"]?></td>
